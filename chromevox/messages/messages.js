...
// mensagens adicionadas para os novos comandos de teclas para identificação do numerador e denominador
msgs.MSG_CHROMEVOX_NUMERATOR_KEY =
    goog.getMsg('key to go  formula numerator');
